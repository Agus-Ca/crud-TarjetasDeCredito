...
namespace BETarjetaCredito
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //Inyectamos el contexto asi luego lo podemos usar por medio de inyeccion de dependecia
            services.AddDbContext<AplicationDbContext>(options => options.UseSqlServer(Configuration.GetConnectionString("DevConnection")));

            //Agregamos lo que son los CORS y una policy diciendo que permita cualquier orige, cualquier cabecera y cualquier metodo
